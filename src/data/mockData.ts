...
// Businesses (Extended with sponsor info)
export const businesses: (Business & { imageUrl?: string; instagramUrl?: string; websiteUrl?: string; location?: string; isSponsor?: boolean })[] = [
  {
    id: '1',
    ...
    instagramUrl: 'https://instagram.com/mercadoboavista',
    location: 'Vista Alegre do Abunã',
  ...
  },
  {
    ...
    location: 'Rua Principal - Vista Alegre',
  ...
  },
  {
    ...
    instagramUrl: 'https://instagram.com/sabordaterra',
    location: 'Rua das Flores - Vista Alegre',
  ...
  },
  {
    ...
    location: 'Avenida Central - Vista Alegre',
  ...
  },
  {
    id: '5',
    name: 'Salão da Maria',
    description: 'Cortes, coloração e tratamentos capilares. Manicure e pedicure.',
    categoryId: '5',
    address: 'Rua das Palmeiras, 88',
    phone: '(69) 3221-0005',
    whatsapp: '5569999990005',
    instagramUrl: 'https://instagram.com/salaodamaria',
